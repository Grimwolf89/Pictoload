...
namespace Pictoload.Data.Migrations
{
    ...
    [Migration("20211110094845_testedx")]
    partial class testedx
    {
            ...
            modelBuilder.Entity("Domain.Entities.Photo", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.TagPhoto", null)
                        .WithMany("Photos")
                        .HasForeignKey("TagPhotoId");
                });
